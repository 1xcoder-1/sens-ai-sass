...
### Added
- Career roadmap feature with AI-generated development paths
- Progress tracking for career roadmaps
- Visualization of career roadmaps using React Flow
- Multiple roadmaps per user support
...
### Changed
- Updated database schema to allow multiple roadmaps per user
...
- Fixed roadmap visualization issues where diagrams were not showing properly
