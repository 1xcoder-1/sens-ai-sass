        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-5 gap-2">
          ...
          {userProfile && (
            <div className="text-sm text-muted-foreground sm:text-right">
              {userProfile.industry ? `Specializing in ${userProfile.industry}` : 'Profile not complete'}
            </div>
          )}
        </div>
      </motion.div>
      ...
      >
        <Link href="/interview/mock" className="w-full sm:w-auto">
          <Button size="lg" className="gap-2 w-full sm:w-auto">
            ...
            <span className="whitespace-nowrap">Start New Quiz</span>
          </Button>
        </Link>
        <Button 
          variant="outline" 
        ...
        >
          ...
          <span className="whitespace-nowrap">Interview Tips</span>
        </Button>
        <Button 
          variant="outline" 
          size="lg" 
        ...
        >
          ...
          <span className="whitespace-nowrap">Practice Timer</span>
        </Button>
      </motion.div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-center gap-2 flex-wrap">
                  ...
                  <Button variant="outline" size="sm" onClick={handleNextQuestion} className="w-12 h-12 sm:w-auto sm:h-auto">
                    <span className="hidden xs:block">Next Question</span>
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-col xs:flex-row items-start xs:items-center justify-between gap-2">
                        <Label htmlFor="auto-next" className="text-sm">Auto next question</Label>
